...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Calculate Match Score Percentage & Gap Analysis
  function calculateMatchScore() {
    const roleData = CAREER_DATA[AppState.profile.targetRole];
    if (!roleData) return { matchPercent: 0, gaps: [] };
    ...
    gaps.sort((a, b) => b.gapValue - a.gapValue); // Highest gap first
  ...
  // Render Market Insights & Salary Tiers (Tab 4)
